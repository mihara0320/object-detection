...
_KEYPOINTBOXCODER = _descriptor.Descriptor(
  ...
  full_name='protos.KeypointBoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_keypoints', full_name='protos.KeypointBoxCoder.num_keypoints', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='y_scale', full_name='protos.KeypointBoxCoder.y_scale', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='x_scale', full_name='protos.KeypointBoxCoder.x_scale', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='height_scale', full_name='protos.KeypointBoxCoder.height_scale', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width_scale', full_name='protos.KeypointBoxCoder.width_scale', index=4,
...
KeypointBoxCoder = _reflection.GeneratedProtocolMessageType('KeypointBoxCoder', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protos.KeypointBoxCoder)
  ))
