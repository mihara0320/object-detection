...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='protos',
  syntax='proto2',
  serialized_pb=_b('\n/object_detection/protos/bipartite_matcher.proto\x12\x17protos\"\x12\n\x10\x42ipartiteMatcher')
)
...
_BIPARTITEMATCHER = _descriptor.Descriptor(
  ...
  full_name='protos.BipartiteMatcher',
  filename=None,
  file=DESCRIPTOR,
...
BipartiteMatcher = _reflection.GeneratedProtocolMessageType('BipartiteMatcher', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protos.BipartiteMatcher)
  ))
