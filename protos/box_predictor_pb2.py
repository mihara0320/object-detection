...
_CONVOLUTIONALBOXPREDICTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='class_prediction_bias_init', full_name='protos.ConvolutionalBoxPredictor.class_prediction_bias_init', index=9,
