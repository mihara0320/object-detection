...
_POSTPROCESSING_SCORECONVERTER = _descriptor.EnumDescriptor(
  name='ScoreConverter',
  full_name='protos.PostProcessing.ScoreConverter',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_BATCHNONMAXSUPPRESSION = _descriptor.Descriptor(
  ...
  full_name='protos.BatchNonMaxSuppression',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='score_threshold', full_name='protos.BatchNonMaxSuppression.score_threshold', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='iou_threshold', full_name='protos.BatchNonMaxSuppression.iou_threshold', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_detections_per_class', full_name='protos.BatchNonMaxSuppression.max_detections_per_class', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_total_detections', full_name='protos.BatchNonMaxSuppression.max_total_detections', index=3,
...
_POSTPROCESSING = _descriptor.Descriptor(
  name='PostProcessing',
  full_name='protos.PostProcessing',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='batch_non_max_suppression', full_name='protos.PostProcessing.batch_non_max_suppression', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='score_converter', full_name='protos.PostProcessing.score_converter', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='logit_scale', full_name='protos.PostProcessing.logit_scale', index=2,
...
BatchNonMaxSuppression = _reflection.GeneratedProtocolMessageType('BatchNonMaxSuppression', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protos.BatchNonMaxSuppression)
  ))
...
PostProcessing = _reflection.GeneratedProtocolMessageType('PostProcessing', (_message.Message,), dict(
  ...
  __module__ = 'protos.post_processing_pb2'
  # @@protoc_insertion_point(class_scope:protos.PostProcessing)
  ))
