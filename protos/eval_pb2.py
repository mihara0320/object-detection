...
_EVALCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_examples', full_name='protos.EvalConfig.num_examples', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eval_interval_secs', full_name='protos.EvalConfig.eval_interval_secs', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_evals', full_name='protos.EvalConfig.max_evals', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='save_graph', full_name='protos.EvalConfig.save_graph', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='visualization_export_dir', full_name='protos.EvalConfig.visualization_export_dir', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eval_master', full_name='protos.EvalConfig.eval_master', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metrics_set', full_name='protos.EvalConfig.metrics_set', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='export_path', full_name='protos.EvalConfig.export_path', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ignore_groundtruth', full_name='protos.EvalConfig.ignore_groundtruth', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_moving_averages', full_name='protos.EvalConfig.use_moving_averages', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='eval_instance_masks', full_name='protos.EvalConfig.eval_instance_masks', index=11,
