...
_FASTERRCNN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='second_stage_mask_prediction_loss_weight', full_name='protos.FasterRcnn.second_stage_mask_prediction_loss_weight', index=25,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hard_example_miner', full_name='protos.FasterRcnn.hard_example_miner', index=26,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='second_stage_classification_loss', full_name='protos.FasterRcnn.second_stage_classification_loss', index=27,
...
_FASTERRCNNFEATUREEXTRACTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_norm_trainable', full_name='protos.FasterRcnnFeatureExtractor.batch_norm_trainable', index=2,
