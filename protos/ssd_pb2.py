...
_SSDFEATUREEXTRACTOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pad_to_multiple', full_name='protos.SsdFeatureExtractor.pad_to_multiple', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_norm_trainable', full_name='protos.SsdFeatureExtractor.batch_norm_trainable', index=5,
