...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='protos',
  syntax='proto2',
  serialized_pb=_b('\n%object_detection/protos/matcher.proto\x12\x17protos\x1a,object_detection/protos/argmax_matcher.proto\x1a/object_detection/protos/bipartite_matcher.proto\"\xa4\x01\n\x07Matcher\x12@\n\x0e\x61rgmax_matcher\x18\x01 \x01(\x0b\x32&.protos.ArgMaxMatcherH\x00\x12\x46\n\x11\x62ipartite_matcher\x18\x02 \x01(\x0b\x32).protos.BipartiteMatcherH\x00\x42\x0f\n\rmatcher_oneof')
  ,
...
_MATCHER = _descriptor.Descriptor(
  name='Matcher',
  full_name='protos.Matcher',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='argmax_matcher', full_name='protos.Matcher.argmax_matcher', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bipartite_matcher', full_name='protos.Matcher.bipartite_matcher', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='matcher_oneof', full_name='protos.Matcher.matcher_oneof',
...
Matcher = _reflection.GeneratedProtocolMessageType('Matcher', (_message.Message,), dict(
  DESCRIPTOR = _MATCHER,
  __module__ = 'protos.matcher_pb2'
  # @@protoc_insertion_point(class_scope:protos.Matcher)
  ))
