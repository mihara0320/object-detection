...
_ARGMAXMATCHER = _descriptor.Descriptor(
  name='ArgMaxMatcher',
  full_name='protos.ArgMaxMatcher',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='matched_threshold', full_name='protos.ArgMaxMatcher.matched_threshold', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unmatched_threshold', full_name='protos.ArgMaxMatcher.unmatched_threshold', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ignore_thresholds', full_name='protos.ArgMaxMatcher.ignore_thresholds', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='negatives_lower_than_unmatched', full_name='protos.ArgMaxMatcher.negatives_lower_than_unmatched', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='force_match_for_each_row', full_name='protos.ArgMaxMatcher.force_match_for_each_row', index=4,
...
ArgMaxMatcher = _reflection.GeneratedProtocolMessageType('ArgMaxMatcher', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protos.ArgMaxMatcher)
  ))
