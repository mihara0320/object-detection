...
_GRIDANCHORGENERATOR = _descriptor.Descriptor(
  ...
  full_name='protos.GridAnchorGenerator',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='protos.GridAnchorGenerator.height', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width', full_name='protos.GridAnchorGenerator.width', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='height_stride', full_name='protos.GridAnchorGenerator.height_stride', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width_stride', full_name='protos.GridAnchorGenerator.width_stride', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='height_offset', full_name='protos.GridAnchorGenerator.height_offset', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width_offset', full_name='protos.GridAnchorGenerator.width_offset', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scales', full_name='protos.GridAnchorGenerator.scales', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='aspect_ratios', full_name='protos.GridAnchorGenerator.aspect_ratios', index=7,
...
GridAnchorGenerator = _reflection.GeneratedProtocolMessageType('GridAnchorGenerator', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protos.GridAnchorGenerator)
  ))
